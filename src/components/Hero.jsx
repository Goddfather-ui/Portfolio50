...
export default function Hero() {
    return (
       ...
       <section id="home" className="relative min-h-[75vh] md:min-h-screen flex items-center justify-center bg-white-500 text-black px-4 sm:px-6 w-full">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
          <Title text="Hi, I'm Korede" tagName="h1"/> 
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-6 text-black-600">
              Creative <span className="gradient-text">Developer</span> & Designer
            </h2>
            <p className="text-lg text-black-200 mb-8 max-w-lg">
